<template>
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con"
            ...
            <div class="logo-con">
                <img v-show="!hideMenuText" src="../../assets/logo.png" key="max-logo"/>
                <img v-show="hideMenuText" src="../../assets/logo-min.png" key="min-logo"/>
            </div>
                ...
                <div class="header-avator-con">
                    <div class="user-dropdown-menu-con">
                        <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
                            ...
                            <Avatar icon="person" style="background: #48c2a9;margin-left: 10px;"></Avatar>
                        </Row>
                    </div>
                </div>
            </div>
