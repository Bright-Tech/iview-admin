...
<template>
    <div ref="scrollCon" @mousewheel="handlescroll" class="tags-outer-scroll-con d-flex flex-row">

        <div ref="scrollBody" class="tags-inner-scroll-body d-flex flex-row container-fluid" :style="{left: tagBodyLeft + 'px'}">
        ...
        <div class="close-all-tag-con ml-auto">
